...
file_xml ='C:\Users\himan\Documents\Himani-Data\Git-Working\python\Config\\book2.xml'
file_json='C:\\Users\\himan\\Documents\\Himani-Data\\Git-Working\\python\\Config\\facebook.json'

def list_articles_on_NYT(base_url):
...
def list_heading_NYT_2(base_url):
    html = urllib.urlopen(base_url).read()
    soup = BeautifulSoup(html, 'html.parser')
...
def travel_xml_for_any_file():
    ...
    tree = ET.parse('C:\Users\himan\Documents\Himani-Data\Git-Working\python\Config\\books.xml')
    root = tree.getroot()
...
if __name__== "__main__":
    ...
    while choice != 'q':
        ...
        if choice.lower() == 'q':
            ...
            list_articles_on_NYT("http://www.nytimes.com/")
            break
        elif (choice=='2'):
            list_heading_NYT_2("http://www.nytimes.com/")
            break
        elif (choice=='3'):
            website_article_as_text()
            break
        elif (choice=='4'):
            print_url()
            break
